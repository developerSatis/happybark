                    ...
                    <div class="row">
                        <div class="col-sm-3 collection-filter">
                            ...
                            <div class="collection-mobile-back"><span class="filter-back"><i
                                    class="fa fa-angle-left" aria-hidden="true"></i> back</span></div>
                            ...
                            <div class="collection-filter-block">
                                <div class="product-service">
                                    <div class="media">
                                        <svg viewbox="0 -117 679.99892 679">
                                            <path
                                    ...
                                    <div class="media">
                                        <svg viewbox="0 -14 512.00001 512">
                                            <path
                        ...
                        <div class="col-lg-9 col-sm-12 col-xs-12">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="filter-main-btn mb-2"><span class="filter-btn"><i
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="product-slick">
                                            @foreach ($product->imagess as $item)
                                                <div><img src="{{asset('storage/product/'.$item)}}" alt=""
                                    ...
                                    <div class="col-lg-6 rtl-text">
                                        <div class="product-right">
                                            <h2>{{$product->name}}</h2>
                                            <h4><del>${{$product->unit_price}}</del><span>{{$product->discount}} {{$product->discount_type === "percent" ?"%" : 'flat'}} off</span></h4>
                                            <h3>${{$product->purchase_price}}</h3>
                                            <!-- <ul class="color-variant">
                                            <li class="bg-light2  mr-2 rounded-circle "></li>
                                            <li class="bg-light1 mr-2 rounded-circle "></li>
                                            <li class="bg-light0 mr-2 rounded-circle "></li>
                                        </ul> -->
                                            <div class="product-description border-product">
                                                ...
                                                <div class="size-box ">
                                                    <ul>
                                                        <li class="active"><a href="javascript:void(0);">1kg</a></li>
                                            ...
                                            <div class="product-buttons"><a href="javascript::Void(0)" onclick="addToCart()">
                                                <button class="btn_dark">add to cart</button></a>
                                                     <a href="javascript:void(0);"
                                                    ><button class="btn_dark">buy now</button></a></div>
                                            ...
                                            <div class="border-product">
                                                ...
                                                <div class="product-icon">
                                                    <ul class="product-social d-flex">
                                            ...
                                            <div class="tab-pane fade" id="top-review" role="tabpanel"
                                                ...
                                                <form class="theme-form">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <button class="btn btn_dark" type="submit">Submit Your
                                                                Review</button>
                                                        </div>
                                                    </div>
                                                </form>
