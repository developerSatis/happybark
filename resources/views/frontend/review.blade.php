...
<!--review-page start -->
<section class="section-b-space blog-detail-page review-page common-bg">
        ...
        <div class="row">
            <div class="col-sm-12">
                <ul class="comment-section">
                    <li>
                        <div class="media"><img src="../assets/images/review/4.jpg"
                            ...
                            <div class="media-body">
                                ...
                                <ul class="comnt-sec">
                                    <li><a href="javascript:void(0);"><i class="fa fa-thumbs-o-up"
                    ...
                    <li>
                        <div class="media"><img src="../assets/images/review/5.jpg"
                                                alt="Generic placeholder image">
                            <div class="media-body">
                                <h6>Mark Jecno <span>( 12 Jannuary 2019 at 1:30AM )</span></h6>
                                <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis
                    ...
                    <li>
                        <div class="media"><img src="../assets/images/review/1.jpg"
                                                alt="Generic placeholder image">
                            <div class="media-body">
                                <h6>Mark Jecno <span>( 12 Jannuary 2019 at 1:30AM )</span></h6>
                                <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis
                    ...
                    <li>
                        <div class="media"><img src="../assets/images/review/2.jpg"
                                                alt="Generic placeholder image">
                            <div class="media-body">
                                <h6>Mark Jecno <span>( 12 Jannuary 2019 at 1:30AM )</span></h6>
                                <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis
                    ...
                    <li>
                        <div class="media"><img src="../assets/images/review/3.jpg"
                                                alt="Generic placeholder image">
                            <div class="media-body">
                                <h6>Mark Jecno <span>( 12 Jannuary 2019 at 1:30AM )</span></h6>
                                <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis
